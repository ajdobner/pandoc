...
inlineEnvironments = M.fromList [
  ...
  , ("alignat*", mathEnvWith id (Just "alignat*") "alignat*")
  , ("dmath", mathEnvWith id (Just "dmath") "dmath")
  , ("dmath*", mathEnvWith id (Just "dmath*") "dmath*")
  , ("dgroup", mathEnvWith id (Just "dgroup") "dgroup")
  , ("dgroup*", mathEnvWith id (Just "dgroup*") "dgroup*")
  , ("darray", mathEnvWith id (Just "darray") "darray")
  , ("darray*", mathEnvWith id (Just "darray*") "darray*")
  , ("subequations", mathEnvWith id (Just "subequations") "subequations")
  ]
